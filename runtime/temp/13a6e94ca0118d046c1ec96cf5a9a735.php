<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./oscshop/merchant\view\daikou\index.html";i:1508465789;s:40:"./oscshop/merchant\view\public\base.html";i:1508463716;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<script>
    ...
    $('#scOrder').on('click', function(){
        ...
        $.ajax({
            url: "<?php echo url('Daikou/get_sc_order'); ?>",
            type: 'post',
            dataType: 'json',
            data: postdata,
    ...
    $('#form').on('submit', function(){
        ...
        $.ajax({
            url: "<?php echo url('Daikou/daikou_pay'); ?>",
            type: 'post',
            dataType: 'json',
            data: postdata,
            success: function(res){
